...
{
    public class lineal_mes_margen_bruto
    {
        ...
        public List<Ranking_Margenes> devolver_mes_mg_lineal(int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania monedadestino)
        {
            ...
            if (conexion.State != ConnectionState.Open)
            {
                ...
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[MargenBrutoLineMes]", conexion);
            ...
            foreach (var lista_mes in lst)
            {
                ...
                if (lista_mes.importe_actual > 0 && lista_mes.coste_actual > 0)
                {
                    ...
                    {
                        conexion.Open();
                        SqlCommand sqlCmd1 = new SqlCommand("[MargenBrutoLineMes_tipoproductoid]", conexion);
        ...
        public List<Ranking_Margenes> devolver_mes_mg_lineal_torta(int anioant, int anio, string mes, Compania info_compania, decimal idDB)
        {
            List<Ranking_Margenes> lst = new List<Ranking_Margenes>();
