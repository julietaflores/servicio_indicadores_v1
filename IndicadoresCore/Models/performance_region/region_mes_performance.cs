...
{
    public class region_mes_performance
    {
        ...
        public List<Ranking> devolver_mes_region(int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania moneda_destino)
        {
        ...
        public List<Ranking> devolver_mes_region_torta(int anioant, int anio, string mes, Compania infocompania,  decimal idDB, MonedaCompania moneda_destino)
        {
            List<Ranking> lst = new List<Ranking>();
            double totap = 0;
            ...
            if (conexion.State != ConnectionState.Open)
            {
                ...
                sqlCmd.CommandTimeout = 0;
                sqlCmd.Parameters.AddWithValue("@iddbempresa", idDB);
                sqlCmd.Parameters.AddWithValue("@companiaid",infocompania.IdCompaniaOdoo);
                sqlCmd.Parameters.AddWithValue("@monedaid", infocompania.IdMonedaOdoo);
                sqlCmd.Parameters.AddWithValue("@anioact", anio);
                sqlCmd.Parameters.AddWithValue("@anioant", anioant);
                sqlCmd.Parameters.AddWithValue("@mess", mes);
                SqlDataAdapter da = new SqlDataAdapter(sqlCmd);
