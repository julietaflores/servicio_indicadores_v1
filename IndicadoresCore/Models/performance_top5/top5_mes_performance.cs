...
{
    public class top5_mes_performance
    {
        ClaseConexion ClaseConexiond = new ClaseConexion();


        public List<Ranking> devolver_mes_top5(int anioant, int anio, string mes, Compania info_compania,  decimal idDB, MonedaCompania moneda_destino)
        {
                ...
                for (int nn = 1; nn <= 3; nn++)
                {
                    switch (nn)
                    {
                        ...
                        case 3:
                            ...
                            Devolucion devolucion3 = precio_Promedio_3.devolver_Precio_Promedio_mesanual(anioant, anio, mes, info_compania, idDB, lista_mes.idPosicion);
