...
namespace IndicadoresCore.Models.margen_bruto_regiones
{
    public class acumulado_region
    {
        ...
        public List<Ranking_Margenes> devolver_acumulado_region_torta(int anioant, int anio, string mes, Compania info_compania,  decimal idDB)
        {
            ...
            if (conexion.State != ConnectionState.Open)
            {
                ...
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[MargenBrutoRegionAnual]", conexion);
                ...
                da.Fill(dt);
                lst = Conversor.listarankingmargen_bruto(dt.Select());
            ...
            foreach (var lista_mes in lst)
            {
                ...
                if (lista_mes.importe_actual > 0 && lista_mes.coste_actual > 0)
                {
                    ...
                    {
                        conexion.Open();
                        SqlCommand sqlCmd1 = new SqlCommand("[MargenBrutoRegionAnual_x_ciudad]", conexion);
                        ...
                        lstr = Conversor.listarankingmargen_bruto1(dt1.Select().FirstOrDefault());
        ...
        public List<Ranking_Margenes> devolver_acumulado_region(int anioant, int anio, string mes, Compania info_compania,  decimal idDB, MonedaCompania monedadestino)
        {
            List<Ranking_Margenes> lst = new List<Ranking_Margenes>();
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
