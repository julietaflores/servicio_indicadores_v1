...
{
    public class mes_region
    {


        ClaseConexion ClaseConexiond = new ClaseConexion();
        public List<Ranking_Margenes> devolver_mes_region_torta(int anioant, int anio, string mes, Compania info_compania, decimal idDB)
        {
            ...
            foreach (var lista_mes in lst)
            {
                ...
                if (lista_mes.importe_actual > 0 && lista_mes.coste_actual > 0)
                {
                    ...
                    if (lstr.importe_actual > 0 && lstr.coste_actual > 0)
                    {
                        ...
                        llenar.porcentaje_margen_anterior = gross_margin_anterior;
                    ...
                    else
                    {
                        ...
                        llenar.importe_anterior = 0;

                        lista_mes.coste_anterior = 0;
                        llenar.coste_anterior = 0;
                        
                        lista_mes.porcentaje_margen_anterior = 0;
                        llenar.porcentaje_margen_anterior = 0;
        ...
        public List<Ranking_Margenes> devolver_mes_region(int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania monedadestino)
        {
            List<Ranking_Margenes> lst = new List<Ranking_Margenes>();
