...
namespace IndicadoresCore.Models.margen_bruto_top5
{
    public class acumulado_top5
    {
        ...
        public List<Ranking_Margenes> devolver_top5_acumulado(int anioant, int anio, string mes, Compania info_compania,  decimal idDB, MonedaCompania monedadestino)
        {
            ...
            {
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[MargenBrutoTop5Anual]", conexion);
            ...
            foreach (var lista_mes in lst)
            {
                ...
                if (lista_mes.importe_actual > 0 && lista_mes.coste_actual > 0)
                {
                    ...
                    if (conexion.State != ConnectionState.Open)
                    {
                        ...
                        conexion.Open();
                        SqlCommand sqlCmd1c = new SqlCommand("[MargenBrutoTop5Anual_x_producto]", conexion);
        ...
        public List<Ranking_Margenes> devolver_top5_acumulado_torta(int anioant, int anio, string mes, Compania info_compania, decimal idDB)
        {
            List<Ranking_Margenes> lst = new List<Ranking_Margenes>();
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
