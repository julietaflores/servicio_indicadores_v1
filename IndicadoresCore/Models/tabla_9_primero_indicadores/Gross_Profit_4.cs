...
namespace IndicadoresCore.Models.tabla_9_primero_indicadores
{
    public class Gross_Profit_4
    {
        ...
        public Devolucion devolver_gross_profit_4(Usuario usuario,int anioant, int anio, string mes, Compania info_compania,  decimal idDB, MonedaCompania moneda_destino)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            indicadorf = indicadorBC.datosindicador_lang(5,usuario.CodIdioma);
