...
namespace IndicadoresCore.Models.tabla_9_primero_indicadores
{
    public class Ventas_2
    {
        ...
        public Devolucion devolver_ventas_2(Usuario usuario,int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania moneda_destino)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            indicadorf = indicadorBC.datosindicador_lang(2, usuario.CodIdioma);
        ...
        public Devolucion devolver_ventas_mesanual(int anioant, int anio, string mes, Compania info_compania, decimal idDB,  decimal proidd)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
        ...
        public Devolucion devolver_ventas_mesanual_performanceregion(int anioant, int anio, string mes, Compania info_compania,  decimal idDB,  decimal ciudadid)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
