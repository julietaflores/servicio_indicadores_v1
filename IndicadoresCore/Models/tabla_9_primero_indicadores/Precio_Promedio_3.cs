...
namespace IndicadoresCore.Models.tabla_9_primero_indicadores
{
    public class Precio_Promedio_3
    {
        ...
        public Devolucion devolver_Precio_Promedio_3(Usuario usuario,int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania moneda_destino)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            indicadorf = indicadorBC.datosindicador_lang(3,usuario.CodIdioma);
        ...
        public Devolucion devolver_Precio_Promedio_mesanual(int anioant, int anio, string mes, Compania info_compania, decimal idDB, decimal proidd)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
        ...
        public Devolucion devolver_Precio_Promedio_mesanual_performanceregion(int anioant, int anio, string mes, Compania info_compania,  decimal idDB,  decimal ciudadid)
        {
            SqlConnection conexion = new SqlConnection(ClaseConexiond.con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
