...
{
    public class PrecioPromedio_lineal
    {
        ...
        public Devolucion devolver_Precio_Promedio_mesanual_performancelineal(int anioant, int anio, string mes, Compania info_campania,  decimal idDB, decimal tproductoid)
        {
            ...
            {
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[performancelineal_pp]", conexion);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = 0;
                sqlCmd.Parameters.AddWithValue("@iddbempresa", idDB);
                sqlCmd.Parameters.AddWithValue("@companiaid", info_campania.IdCompaniaOdoo);
                sqlCmd.Parameters.AddWithValue("@monedaid", info_campania.IdMonedaOdoo);
