...
{
    public class lineal_mes_performance
    {
        ...
        public List<Ranking> devolver_mes_lineal(int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania moneda_destino)
        {
            ...
            {
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[PerformaceLinealMes]", conexion);
        ...
        public List<Ranking> devolver_mes_lineal_torta(int anioant, int anio, string mes, Compania info_compania, decimal idDB, MonedaCompania moneda_destino)
        {
