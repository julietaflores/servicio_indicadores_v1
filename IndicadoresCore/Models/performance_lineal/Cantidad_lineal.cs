...
namespace IndicadoresCore.Models.performance_lineal
{
    public class Cantidad_lineal
    {
        ...
        public Devolucion devolver_cantidad_mesanual_performancelineal(int anioant, int anio, string mes, Compania info_compania,  decimal idDB,  decimal tproductoid)
        {
            ...
            if (conexion.State != ConnectionState.Open)
            {
                ...
                conexion.Open();
                SqlCommand sqlCmd = new SqlCommand("[performancelineal_cantidad]", conexion);
